...
public class PipeManager : MonoBehaviour
{
    ...
    {
        GameObject pipe = Instantiate(pipePrefab, currentPos, Quaternion.LookRotation(currentDir));
        pipe.transform.localScale = new Vector3(0.1f, 0.1f, pipeLength);
    ...
    bool PlaceBend()
    {
        ...
        {
            if (dir != -currentDir && IsValidPosition(currentPos + dir * pipeLength))
            {
        ...
        currentDir = newDir;
        currentPos += currentDir * (pipeLength / 2);
